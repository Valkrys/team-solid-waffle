...
INSERT INTO band(bandName, commercial, communication, innovation, customerFocus, development, planning, knowledge, responsibilities, trainingID, bandRank)
    VALUES ('Apprentice', "", "", "", "", "", "", "", "", null, 1),
       ...
       ('Trainee',
        ...
        You willingly cooperate by volunteering to take on additional tasks that will benefit the business eg Recruitment events such as University careers fairs, EAYL open evening, Work experience mentoring.
        ...
        "You are flexible and willing to learn. You set SMART objectives in Workday and discuss and agree with your manager.",
       ...
       ('Senior Associate',
        ...
        You give advice and guidance and provide practical support to others to help them understand tasks.
        You give 'how to' demonstrations or instructions and explain how others can achieve performance expectations", "You overcome obstacles to ensure work gets done on time
       ...
       ('Consultant',
        ...
        You are aware of and actively use project/financial information to manage profitability eg revisiting estimates.
        ...
        You proactively identify internal and external talent and support them in finding developmental opportunities eg recruitment, career coaching.",
       ...
       ('Manager',
        ...
        You understand the people risk within your team and mitigate and proactively manage ensuring adherence to policies and processes eg Retention/Succession Planning/Well Being)",
